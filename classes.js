class Sprite {
    ...
    constructor({position, image, frames = { max : 1, hold: 10 }, sprites, animate = false, offset, rotation = 0}) { //whenever you create a new instance of a sprite, we call this code first!  
